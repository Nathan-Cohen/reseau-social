    ...
    var directiveDef = {
        controller: function($scope, SocketService){
            ...
            $scope.envoieMessage = function(){
                console.log('testenvoiemsg', $scope.msgBox)
                $scope.msgBox = ''
            }
        ...
        template: `
            <div class="col-md-5 chatbox" ng-if="testAfficheChatBot">
                    ...
                    <div class="panel-collapse collapse" id="collapseOne">
                        ...
                        <div class="panel-footer">
                            <div class="input-group">
                                <input id="msgBox" ng-model="msgBox" type="text" class="form-control input-sm" placeholder="Type your message here..." />
